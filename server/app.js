...
app.get("/postcode-bgc/:postcode", (req, res, next) => {
...
app.get("/data/:postcode",(req,res,next) =>{
    //results.length = 0;
...
app.get("/data/:postcode/:animals/:rating/:region",(req,res,next) =>{
...
app.get("/suggestion/:code",(req,res,next) =>{
    //results.length = 0;
    var theData = [];//build json for response
